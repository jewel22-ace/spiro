...
const r = ["geforce 320m", "geforce 8600", "geforce 8600m gt", "geforce 8800 gs", "geforce 8800 gt", "geforce 9400", "geforce 9400m g", "geforce 9400m", "geforce 9600m gt", "geforce 9600m", "geforce fx go5200", "geforce gt 120", "geforce gt 130", "geforce gt 330m", "geforce gtx 285", "google swiftshader", "intel g41", "intel g45", "intel gma 4500mhd", "intel gma x3100", "intel hd 3000", "intel q45", "legacy", "mali-2", "mali-3", "mali-4", "quadro fx 1500", "quadro fx 4", "quadro fx 5", "radeon hd 2400", "radeon hd 2600", "radeon hd 4670", "radeon hd 4850", "radeon hd 4870", "radeon hd 5670", "radeon hd 5750", "radeon hd 6290", "radeon hd 6300", "radeon hd 6310", "radeon hd 6320", "radeon hd 6490m", "radeon hd 6630m", "radeon hd 6750m", "radeon hd 6770m", "radeon hd 6970m", "radeon r9 200", "sgx 543", "sgx543"],
    ...
    o = (() => {
        ...
        const {
            ...
            platform: r,
            maxTouchPoints: n
        } = window.navigator, o = /(iphone|ipod|ipad)/i.test(e), a = "iPad" === r || "MacIntel" === r && n > 0 && !window.MSStream;
        return {
            isIpad: a,
    ...
    c = (e, r) => {
        ...
        for (; p < o;)
            for (a = r.charCodeAt(c + p), l = p++, s = p, g = 0; g < t; g++) f = a === d[g] ? l : l + 1, l = i[g], s = i[g] = l > s ? f > s ? s + 1 : f : f > l ? l + 1 : f;
        return s
    },
    l = ({
        ...
        benchmarksURL: g = "https://unpkg.com/detect-gpu@3.1.11/dist/benchmarks"
        ...
        const {
            isIpad: u = !!(null == o ? void 0 : o.isIpad),
            isMobile: h = !!(null == o ? void 0 : o.isMobile),
            screenSize: v = window.screen,
            loadBenchmarks: m = (r => e(void 0, void 0, void 0, (function*() {
        ...
        const b = (yield Promise.all(x.map((r => e(void 0, void 0, void 0, (function*() {
            ...
            const l = d.length;
            if (0 === l) return;
            let f, [s, , , g] = l > 1 ? d.map((e => [e, c(r, e[0])])).sort((([, e], [, r]) => e - r))[0][0] : d[0],
                w = Number.MAX_VALUE;
            const {
                devicePixelRatio: A
            } = window, x = v.width * A * (v.height * A);
            i && h && (g = g.filter((([, , , e]) => {
                var r;
                return (null !== (r = null == e ? void 0 : e.indexOf(u ? "ipad" : "iphone")) && void 0 !== r ? r : -1) > -1
            })));
            for (const e of g) {
                const [r, n] = e, t = r * n, o = Math.abs(x - t);
                o < w && (w = o, f = e)
            }
            if (!f) return;
            const [, , S, b] = f;
        ...
        const [, P, C, y] = b.sort((([e = Number.MAX_VALUE], [r = Number.MAX_VALUE]) => e - r))[0];
